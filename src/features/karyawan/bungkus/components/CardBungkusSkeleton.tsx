export default function CardBungkusSkeleton({ count }: { count?: number }) {
  ...
  return (
    <div className="flex-1 w-full flex flex-col gap-3">
      {[...Array(skeletonCount)].map((_, index) => (
        <section
          key={index}
          className="w-full h-48 bg-white dark:bg-neutral-700 rounded-xl border border-neutral-300 dark:border-neutral-600 flex items-center justify-between shadow-sm animate-pulse overflow-hidden"
        >
