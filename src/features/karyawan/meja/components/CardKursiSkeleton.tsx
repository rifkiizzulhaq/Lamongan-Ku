      ...
      <div className="w-full h-full flex flex-col justify-between">
        <div className="flex flex-col px-5 py-3 flex-1">
          ...
          <div className="w-full flex items-center mt-3">
            <div className="w-1/4 h-5 bg-neutral-200 dark:bg-neutral-600 rounded-full"></div>
          </div>
          <div className="w-full flex items-center mt-2">
            <div className="w-1/5 h-4 bg-neutral-200 dark:bg-neutral-600 rounded-md"></div>
          </div>
          <div className="w-full flex gap-2 bg-neutral-50 dark:bg-neutral-900/40 border border-neutral-200/60 dark:border-neutral-800 rounded-lg p-2.5 mt-3 h-16">
