export default function CardRiwayatSkeleton() {
  return (
    <section className="w-full bg-white dark:bg-neutral-700 rounded-xl border border-neutral-300 dark:border-neutral-600 flex items-stretch shadow-sm animate-pulse">
