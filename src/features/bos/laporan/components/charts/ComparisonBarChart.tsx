...
export default function ComparisonBarChart({
  ...
  return (
    <div className="w-full border border-neutral-200 dark:border-neutral-700 rounded-2xl p-5 bg-white dark:bg-neutral-800">
      ...
      <div className="w-full overflow-x-auto overflow-y-hidden pb-1 scrollbar-thin scrollbar-thumb-neutral-200 dark:scrollbar-thumb-neutral-700">
        <div
          style={{
            minWidth: labels.length > 10 ? `${labels.length * 34}px` : "100%",
          }}
        >
          <ReactApexChart
            options={options}
